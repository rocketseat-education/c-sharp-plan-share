...
{
    public static void VerifyGoTo(this Mock<INavigationService> navigationService,
        string route, IList<string> errorMessages, Func<Times> time)
    {
    ...
    public static void VerifyGoTo(
        this Mock<INavigationService> navigationService, string route, Func<Times> time)
    {
